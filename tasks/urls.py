...
from tasks.views import manager_dashboard, employee_dashboard, create_task, view_task, update_task, DeleteView, task_details, dashboard, Greetings, HiGreetings, HiHowGreetings, CreateTask, ViewProject, TaskDetail, UpdateTask
...
urlpatterns = [
    ...
    path('delete-task/<int:id>/', DeleteView.as_view(), name='delete-task'),
